...
void player() {
  ...
  /*    uintptr_t _anticheat = oxorany(151491024);
      ...
      uint64_t gameController = getInstance(proc.base + oxorany(0x911C7A0), false, oxorany(0x8));
      ...
      auto PhotonNetwork = getInstance(proc.base + oxorany(0x9120D60), false, oxorany(0x18));
