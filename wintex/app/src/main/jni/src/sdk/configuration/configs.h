...
static const string CFG_PATH = "/storage/emulated/0/#wintyx_ext/";
...
inline void SaveConfigSelected()
{
    ...
    config["esp.weaponGlowStrength"] = esp.weaponGlowStrength;
    config["esp.weaponGlowColor.r"] = esp.weaponGlowColor[0];
    config["esp.weaponGlowColor.g"] = esp.weaponGlowColor[1];
    config["esp.weaponGlowColor.b"] = esp.weaponGlowColor[2];
    ...
    config["esp.skeletonThickness"] = esp.skeletonThickness;
    config["esp.skeletonGlow"] = esp.skeletonGlow;
    config["esp.skeletonScale"] = esp.skeletonScale;
    config["esp.skeletonOutline"] = esp.skeletonOutline;
    config["esp.skeletonOutlineThickness"] = esp.skeletonOutlineThickness;
    config["esp.skeletonJointDots"] = esp.skeletonJointDots;
    config["esp.skeletonJointSize"] = esp.skeletonJointSize;
    config["esp.skeletonJointColor.r"] = esp.skeletonJointColor[0];
    config["esp.skeletonJointColor.g"] = esp.skeletonJointColor[1];
    config["esp.skeletonJointColor.b"] = esp.skeletonJointColor[2];
    config["esp.skeletonJointGlow"] = esp.skeletonJointGlow;
    config["esp.headCircleStyle"] = esp.headCircleStyle;
    config["esp.headCircleSize"] = esp.headCircleSize;
    ...
    config["esp.bullettraceGlowColor.r"] = esp.bullettraceGlowColor[0];
    config["esp.bullettraceGlowColor.g"] = esp.bullettraceGlowColor[1];
    config["esp.bullettraceGlowColor.b"] = esp.bullettraceGlowColor[2];
    config["esp.bullettraceStyle"] = esp.bullettraceStyle;
    config["esp.bullettraceHitStyle"] = esp.bullettraceHitStyle;
    config["esp.bullettraceFromCrosshair"] = esp.bullettraceFromCrosshair;
    config["esp.bullettraceTime"] = esp.bullettraceTime;
    config["esp.bullettraceThickness"] = esp.bullettraceThickness;
    config["esp.bullettraceHitSize"] = esp.bullettraceHitSize;
    config["esp.bullettraceGlow"] = esp.bullettraceGlow;
    config["esp.bullettraceNeonCore"] = esp.bullettraceNeonCore;
    ...
    config["aimbot.aimTarget"] = aimbot.aimTarget;
    config["aimbot.smoothing"]  = aimbot.smoothing;
    config["aimbot.highline"]  = aimbot.highline;
    config["aimbot.fovRadius"]  = aimbot.fovRadius;
    
    config["aimbot.triggerDelay"] = aimbot.triggerDelay;
    config["esp.rounding"] = esp.rounding;
    config["esp.boxStyle"] = esp.boxStyle;
    config["esp.cornerLength"] = esp.cornerLength;
    config["esp.boxOutlineThickness"] = esp.boxOutlineThickness;
    config["esp.snaplineStyle"] = esp.snaplineStyle;
    config["esp.lineEndStyle"] = esp.lineEndStyle;
    
    config["aimbot.fovVisibleColor.r"] = aimbot.fovVisibleColor[0];
    config["aimbot.fovVisibleColor.g"] = aimbot.fovVisibleColor[1];
    config["aimbot.fovVisibleColor.b"] = aimbot.fovVisibleColor[2];
    config["aimbot.fovInvisibleColor.r"] = aimbot.fovInvisibleColor[0];
    config["aimbot.fovInvisibleColor.g"] = aimbot.fovInvisibleColor[1];
    config["aimbot.fovInvisibleColor.b"] = aimbot.fovInvisibleColor[2];
    ...
    config["esp.hpBarRounding"] = esp.hpBarRounding;
    config["esp.hpAdaptiveColor"] = esp.hpAdaptiveColor;
    ...
    config["esp.armorBarRounding"] = esp.armorBarRounding;
    config["esp.armorAdaptiveColor"] = esp.armorAdaptiveColor;
    ...
    config["esp.nameScale"] = esp.nameScale;
    config["esp.nameOutline"] = esp.nameOutline;
    config["esp.nameOutlineColor.r"] = esp.nameOutlineColor[0];
    config["esp.nameOutlineColor.g"] = esp.nameOutlineColor[1];
    config["esp.nameOutlineColor.b"] = esp.nameOutlineColor[2];
    config["esp.rounding"] = esp.rounding;
    ...
    config["set_score_all"]     = set_score_all;
    config["score_all_v"]       = score_all_v;
    config["hide_id_all"]       = hide_id_all;
    config["hide_clan_tag_all"] = hide_clan_tag_all;
    config["set_death_all"]     = set_death_all;
    config["death_all_v"]       = death_all_v;
    config["set_money_all"]     = set_money_all;
    config["money_all_v"]       = money_all_v;
    config["set_ping_all"]      = set_ping_all;
    config["ping_all_vl"]       = ping_all_vl;
    config["set_kills_all"]     = set_kills_all;
    config["kills_all_v"]       = kills_all_v;
    config["fake_avatar_all"]   = fake_avatar_all;
    config["fake_medal_all"]    = fake_medal_all;
    config["airstafe"]    = airstafe;
    config["aimbot.visibleCheck"] = aimbot.visibleCheck;
    config["aimbot.fovFillEnabled"] = aimbot.fovFillEnabled;
    config["aimbot.fovFillOpacity"] = aimbot.fovFillOpacity;
    config["skip_warmup"] = skip_warmup;
    config["autowin_ct"] = autowin_ct;
    config["autowin_tr"] = autowin_tr;
...
inline void LoadConfigSelected()
{
    ...
    esp.foto = config["esp.foto"].ToBool();
    ...
    esp.hpBarRounding = config["esp.hpBarRounding"].ToFloat();
    esp.hpAdaptiveColor = config["esp.hpAdaptiveColor"].ToBool();
    ...
    esp.armorBarRounding = config["esp.armorBarRounding"].ToFloat();
    esp.armorAdaptiveColor = config["esp.armorAdaptiveColor"].ToBool();
    ...
    esp.nameScale = config["esp.nameScale"].ToFloat();
    esp.nameOutline = config["esp.nameOutline"].ToBool();
    esp.nameOutlineColor[0] = config["esp.nameOutlineColor.r"].ToFloat();
    esp.nameOutlineColor[1] = config["esp.nameOutlineColor.g"].ToFloat();
    esp.nameOutlineColor[2] = config["esp.nameOutlineColor.b"].ToFloat();
    ...
    aimbot.triggerDelay = config["aimbot.triggerDelay"].ToFloat();
    esp.rounding = config["esp.rounding"].ToFloat();
    esp.boxStyle = config["esp.boxStyle"].ToInt();
    esp.cornerLength = config["esp.cornerLength"].ToFloat();
    esp.boxOutlineThickness = config["esp.boxOutlineThickness"].ToFloat();
    esp.snaplineStyle = config["esp.snaplineStyle"].ToInt();
    esp.lineEndStyle = config["esp.lineEndStyle"].ToInt();
    ...
    esp.weaponGlowStrength = config["esp.weaponGlowStrength"].ToFloat();
    esp.weaponGlowColor[0] = config["esp.weaponGlowColor.r"].ToFloat();
    esp.weaponGlowColor[1] = config["esp.weaponGlowColor.g"].ToFloat();
    esp.weaponGlowColor[2] = config["esp.weaponGlowColor.b"].ToFloat();
    ...
    esp.skeletonThickness = config["esp.skeletonThickness"].ToFloat();
    esp.skeletonGlow = config["esp.skeletonGlow"].ToFloat();
    esp.skeletonScale = config["esp.skeletonScale"].ToFloat();
    esp.skeletonOutline = config["esp.skeletonOutline"].ToBool();
    esp.skeletonOutlineThickness = config["esp.skeletonOutlineThickness"].ToFloat();
    esp.skeletonJointDots = config["esp.skeletonJointDots"].ToBool();
    esp.skeletonJointSize = config["esp.skeletonJointSize"].ToFloat();
    esp.skeletonJointColor[0] = config["esp.skeletonJointColor.r"].ToFloat();
    esp.skeletonJointColor[1] = config["esp.skeletonJointColor.g"].ToFloat();
    esp.skeletonJointColor[2] = config["esp.skeletonJointColor.b"].ToFloat();
    esp.skeletonJointGlow = config["esp.skeletonJointGlow"].ToFloat();
    esp.headCircleStyle = config["esp.headCircleStyle"].ToInt();
    esp.headCircleSize = config["esp.headCircleSize"].ToFloat();
    ...
    esp.bullettraceGlowColor[0] = config["esp.bullettraceGlowColor.r"].ToFloat();
    esp.bullettraceGlowColor[1] = config["esp.bullettraceGlowColor.g"].ToFloat();
    esp.bullettraceGlowColor[2] = config["esp.bullettraceGlowColor.b"].ToFloat();
    esp.bullettraceStyle = config["esp.bullettraceStyle"].ToInt();
    esp.bullettraceHitStyle = config["esp.bullettraceHitStyle"].ToInt();
    esp.bullettraceFromCrosshair = config["esp.bullettraceFromCrosshair"].ToBool();
    esp.bullettraceTime = config["esp.bullettraceTime"].ToFloat();
    esp.bullettraceThickness = config["esp.bullettraceThickness"].ToFloat();
    esp.bullettraceHitSize = config["esp.bullettraceHitSize"].ToFloat();
    esp.bullettraceGlow = config["esp.bullettraceGlow"].ToFloat();
    esp.bullettraceNeonCore = config["esp.bullettraceNeonCore"].ToBool();
    ...
    aimbot.aimTarget = config["aimbot.aimTarget"].ToInt();
    aimbot.smoothing = config["aimbot.smoothing"].ToFloat();
    aimbot.highline = config["aimbot.highline"].ToFloat();
    aimbot.fovVisibleColor[0]   = config["aimbot.fovVisibleColor.r"].ToFloat();
    aimbot.fovVisibleColor[1]   = config["aimbot.fovVisibleColor.g"].ToFloat();
    aimbot.fovVisibleColor[2]   = config["aimbot.fovVisibleColor.b"].ToFloat();
    aimbot.fovInvisibleColor[0] = config["aimbot.fovInvisibleColor.r"].ToFloat();
    aimbot.fovInvisibleColor[1] = config["aimbot.fovInvisibleColor.g"].ToFloat();
    aimbot.fovInvisibleColor[2] = config["aimbot.fovInvisibleColor.b"].ToFloat();
    ...
    set_score_all     = config["set_score_all"].ToBool();
    score_all_v       = config["score_all_v"].ToInt();
    hide_id_all       = config["hide_id_all"].ToBool();
    hide_clan_tag_all = config["hide_clan_tag_all"].ToBool();
    set_death_all     = config["set_death_all"].ToBool();
    death_all_v       = config["death_all_v"].ToInt();
    set_money_all     = config["set_money_all"].ToBool();
    money_all_v       = config["money_all_v"].ToInt();
    set_ping_all      = config["set_ping_all"].ToBool();
    ping_all_vl       = config["ping_all_vl"].ToInt();
    set_kills_all     = config["set_kills_all"].ToBool();
    kills_all_v       = config["kills_all_v"].ToInt();
    fake_avatar_all   = config["fake_avatar_all"].ToBool();
    fake_medal_all    = config["fake_medal_all"].ToBool();
    airstafe    = config["airstafe"].ToBool();
    aimbot.visibleCheck = config["aimbot.visibleCheck"].ToBool();
    aimbot.fovFillEnabled = config["aimbot.fovFillEnabled"].ToBool();
    aimbot.fovFillOpacity = config["aimbot.fovFillOpacity"].ToFloat();
    skip_warmup = config["skip_warmup"].ToBool();
    autowin_ct = config["autowin_ct"].ToBool();
    autowin_tr = config["autowin_tr"].ToBool();
}
